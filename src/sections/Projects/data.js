...
const collegemate = {
  ...
  features : [
    'Authentication system', 'Email alerts', 'File sharing',
    'Creating new posts and materials', 'Scheduling based on current time',
    'Dark theme'
  ],
...
const tss = {
  ...
  features : [
    'Command Line Interface', 'AES 256 Encryption', 'Google OAuth',
    'Token Based Authentication', 'Granular Permissions',
...
const ilc = {
  ...
  features : [
    'Registration', 'Online ID Generation', 'Post sharing',
...
const $7d50p = {
  ...
  features :
      [ 'Theme clock', 'Testimonials', 'Movie app', 'Double click like' ],
...
const aubit = {
  ...
  features : [
    'Modern design', 'Online Form downloads', 'Reusable web components',
    'Image Gallery'
  ],
