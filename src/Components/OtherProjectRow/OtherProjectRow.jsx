...
export default function OtherProjectRow({ title, type, technology, children, link, repo }) {
  ...
  return (
    <div className={classes.row} style={!isExpanded ? { borderColor: 'transparent' } : {}} onClick={() => setIsExpanded(!isExpanded)}>
      ...
      <div className={classes.additional} style={!isExpanded ? { maxHeight: 0 } : {}}>
        ...
        <div className={classes.actions}>
          {repo && <Button link={repo}><span className='icon icon-code' />Repo</Button>}
